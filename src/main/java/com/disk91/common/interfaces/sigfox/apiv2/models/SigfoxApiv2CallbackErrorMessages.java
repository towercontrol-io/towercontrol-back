...
@Tag(name="errorMessages", description = "Callback execution errors report")
public class SigfoxApiv2CallbackErrorMessages {
    ...
    @Schema(
            description ="Timestamp of the message in ms (posix format)",
    ...
    @Schema(
            description ="Date of the message in String format",
