...
@Tag(name="baseGroup", description = "Group information returned after and update")
public class SigfoxApiv2GroupBase {
    ...
    @Schema(
            description ="SNO or NIP group id for a DIST & SVNO group. " +
...
//            hidden = true,
    ...
    @Schema(
            description ="True if the group is a leaf.",
            example = "true",
            requiredMode = Schema.RequiredMode.NOT_REQUIRED
    )
    ...
    @Schema(
            description ="This is the country ISO code " +
...
//            hidden = true,
    ...
    @Schema(
            ...
            example = "52a1e627e4b19a9a3dcda2d",
            requiredMode = Schema.RequiredMode.NOT_REQUIRED
    )
    protected String createdBy;

    @Schema(
            description ="Creation Time in MS since Epoc",
            example = "1476288124451",
            requiredMode = Schema.RequiredMode.NOT_REQUIRED
    )
