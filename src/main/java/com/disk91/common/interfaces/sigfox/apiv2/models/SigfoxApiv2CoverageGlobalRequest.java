...
@Tag(name="globalCoverageRequest", description = "Defines the request to post to get global coverage")
public class SigfoxApiv2CoverageGlobalRequest {
    ...
    @Schema(
            description ="The radius of the area in which the coverage results are averaged " +
