...
@Tag(name="apiUser", description = "Defines the base API user’s properties")
public class SigfoxApiv2UserApi {
    ...
    @Schema(
            description ="The associated group information",
            requiredMode = Schema.RequiredMode.NOT_REQUIRED
    )
    protected SigfoxApiv2GroupMinimal group;

    @Schema(
            description ="The API user’s creation time since epoch",
            requiredMode = Schema.RequiredMode.NOT_REQUIRED
    )
    protected long creationTime;

    @Schema(
            description ="The API user’s identifier",
            requiredMode = Schema.RequiredMode.NOT_REQUIRED
    )
    protected String id;

    @Schema(
            description ="The API user’s acces token(password)",
            requiredMode = Schema.RequiredMode.NOT_REQUIRED
    )
    protected String accessToken;

    @Schema(
            description ="The API user’s access rights",
            requiredMode = Schema.RequiredMode.NOT_REQUIRED
    )
