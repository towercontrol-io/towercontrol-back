 ...
 * -------------------------------------------------------------------------------
 */
package com.disk91.common.interfaces.sigfox.apiv2.models;
...
@Tag(name="callbackCreation", description = "Information to register a callback")
public class SigfoxApiv2CallbackCreation extends SigfoxApiv2CallbackCommonDef {
    ...
    @Schema(
            ...
            example = "https://foo.bar/sigfoxCallback/",
    ...
    @Schema(
            description ="The content type of the request, only taken into account for POST requests. Available content types are " +
                    "<ul>" +
                    "<li>text/plain</li>" +
    ...
    @Schema(
            description ="The line pattern representing a message. Mandatory for BATCH_URL callbacks.",
            example = "",
            requiredMode = Schema.RequiredMode.NOT_REQUIRED
    )
    ...
    @Schema(
            description ="The mail subject. Mandatory for EMAIL callbacks.",
    ...
    @Schema(
            description ="The recipient of the email. Must be a valid email address. " +
    ...
    @Schema(
            description ="The content of the message. Mandatory for EMAIL callbacks.",
