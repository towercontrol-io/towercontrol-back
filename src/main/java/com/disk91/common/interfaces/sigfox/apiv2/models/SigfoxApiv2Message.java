...
@Tag(name="deviceMessage", description = "Message received from a device")
public class SigfoxApiv2Message {
    ...
    @Schema(
            description ="Link quality indicator for repeated message<br/>" +
            "<ul>" +
            "<li>0 -> LIMIT</li>" +
            "<li>1 -> AVERAGE</li>" +
            "<li>2 -> GOOD</li>" +
    ...
    @Schema(
            description ="The sequence number for this message, may not be " +
    ...
    @Schema(
            description ="NbFrames can be 1 or 3. This value represents an expected " +
    ...
    @Schema(
            description ="Message computed location",
            requiredMode = Schema.RequiredMode.NOT_REQUIRED
    )
    protected SigfoxApiv2ComputedLocation computedLocation;

    @Schema(
            description ="Message Reception detailed information.",
            requiredMode = Schema.RequiredMode.NOT_REQUIRED
    )
    protected SigfoxApiv2MessageRInfo rinfos;

    @Schema(
            description ="Status of the downlink communication.",
            requiredMode = Schema.RequiredMode.NOT_REQUIRED
    )
