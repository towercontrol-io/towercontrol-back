...
@Tag(name = "callbackErrorMessageList", description = "List of callback not delivered for a given group")
public class SigfoxApiv2DeviceTypeListResponse {
    ...
    protected List<SigfoxApiv2DeviceTypeGlobal> data;
    ...
    public List<SigfoxApiv2DeviceTypeGlobal> getData() {
        return data;
    }

    public void setData(List<SigfoxApiv2DeviceTypeGlobal> data) {
        this.data = data;
    }
